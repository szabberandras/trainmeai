...
// Additional women's training plans data
const additionalWomenPlans = {
    ...
    "workouts": [
      {
        ...
        "exercises": [
          {
            "exercise_id": "dumbbell-calf-raise-to-high-pull",
          ...
          {
            "exercise_id": "standing-machine-calf-press",
      ...
      },
      {
        ...
        "exercises": [
          ...
          {
            "exercise_id": "standing-dumbbell-calf-raise",
          ...
          {
            "exercise_id": "barbell-seated-calf-raise",
          ...
          {
            "exercise_id": "seated-dumbbell-calf-raise",
      ...
      },
      {
        ...
        "exercises": [
          ...
          {
            "exercise_id": "seated-dumbbell-one-leg-calf-raise",
          ...
          {
            "exercise_id": "standing-kettlebell-calf-raise",
          ...
          {
            "exercise_id": "calf-raise-to-shrug",
          ...
          {
            "exercise_id": "dumbbell-calf-raise-to-shrug",
          ...
          {
            "exercise_id": "smith-machine-reverse-calf-raises",
...
function addAdditionalWomenPlans() {
  try {
    ...
    // Add new plans before the closing brace
    let newPlansString = '';
    for (const [planId, planData] of Object.entries(additionalWomenPlans)) {
    ...
    console.log(`📊 Added ${Object.keys(additionalWomenPlans).length} new training plan categories`);
    
    // Count total workouts added
    const totalWorkouts = Object.values(additionalWomenPlans).reduce((sum, plan) => sum + plan.workouts.length, 0);
    console.log(`🏋️‍♀️ Added ${totalWorkouts} individual workouts`);
    
    return true;
  } catch (error) {
    console.error('❌ Error adding additional women\'s plans:', error);
    return false;
  }
}
...
if (require.main === module) {
  addAdditionalWomenPlans();
}

module.exports = { addAdditionalWomenPlans }; 