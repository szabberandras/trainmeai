        ...
        <div className="space-y-4">
          ...
          {[
            ...
            },
            {
              ...
              description: 'Muscle groups, safety notes, modifications, coaching cues',
              icon: Dumbbell
            },
            {
              ...
              <div className="space-y-6">
                {day.exercises.map((exercise, exerciseIndex) => (
                  <div key={exerciseIndex} className="border-l-4 border-gray-300 pl-6">
                    ...
                    {exportOptions.exerciseDetails && (
                      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                        {exercise.muscleGroups && (
                          <div>
                            <h6 className="font-medium mb-2 text-gray-900">Muscle Groups:</h6>
                            <p className="text-gray-700">{exercise.muscleGroups.join(', ')}</p>
                          </div>
                        )}

                        {exercise.difficulty && (
                          <div>
                            <h6 className="font-medium mb-2 text-gray-900">Difficulty:</h6>
                            <div className="flex items-center gap-1">
                              {[...Array(5)].map((_, i) => (
                                <div
                                  key={i}
                                  className={`w-3 h-3 rounded-full ${
                                    i < exercise.difficulty! ? 'bg-gray-900' : 'bg-gray-200'
                                  }`}
                                />
                              ))}
                              <span className="ml-2 text-gray-600">({exercise.difficulty}/5)</span>
                            </div>
                          </div>
                        )}
                        ...
                        {exercise.safetyNotes && (
                          <div className="md:col-span-2">
                            <h6 className="font-medium mb-2 text-red-700">Safety Notes:</h6>
                        ...
                        {exercise.modifications && (
                          <div className="md:col-span-2">
                            <h6 className="font-medium mb-2 text-gray-900">Modifications:</h6>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div className="p-3 bg-green-50 rounded-xl border border-green-200">
                                <span className="font-medium text-green-700">Beginner: </span>
                                <span className="text-gray-700">{exercise.modifications.beginner}</span>
                              </div>
                              <div className="p-3 bg-blue-50 rounded-xl border border-blue-200">
                                <span className="font-medium text-blue-700">Advanced: </span>
                                <span className="text-gray-700">{exercise.modifications.advanced}</span>
                              </div>
                            </div>
                          </div>
                        )}
                        ...
                        {exercise.coaching && (
                          <div className="md:col-span-2">
                            <h6 className="font-medium mb-3 text-gray-900">Coaching Cues:</h6>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              {exercise.coaching.setup && (
                                <div className="p-3 bg-blue-50 rounded-xl border border-blue-200">
                                  <div className="font-medium text-blue-700 mb-2">Setup:</div>
                                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                                    {exercise.coaching.setup.map((cue, i) => (
                                      <li key={i} className="text-sm">{cue}</li>
                                    ))}
                                  </ul>
                                </div>
                              )}
                              {exercise.coaching.execution && (
                                <div className="p-3 bg-green-50 rounded-xl border border-green-200">
                                  <div className="font-medium text-green-700 mb-2">Execution:</div>
                                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                                    {exercise.coaching.execution.map((cue, i) => (
                                      <li key={i} className="text-sm">{cue}</li>
                                    ))}
                                  </ul>
                                </div>
                              )}
                              {exercise.coaching.common_mistakes && (
                                <div className="p-3 bg-red-50 rounded-xl border border-red-200">
                                  <div className="font-medium text-red-700 mb-2">Avoid:</div>
                                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                                    {exercise.coaching.common_mistakes.map((mistake, i) => (
                            ...
                            {exercise.coaching.breathing && (
                              <div className="mt-3 p-3 bg-purple-50 rounded-xl border border-purple-200">
                                <span className="font-medium text-purple-700">Breathing: </span>
                                <span className="text-gray-700">{exercise.coaching.breathing}</span>
                              </div>
                            )}
                          </div>
                        )}
